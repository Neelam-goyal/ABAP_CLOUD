...
CLASS YCL_FI_PRINT IMPLEMENTATION.
...
*     WHERE fiscalyear         = ls_itm-fiscalyear
*       AND accountingdocument = ls_itm-accountingdocument
*       AND companycode        = ls_itm-companycode
*       AND product            = ls_item-item_name.
*
...
* LOOP AT dedc INTO DATA(no_bags) WHERE fiscalyear  = ls_itm-fiscalyear
*                 and    accountingdocument = ls_itm-accountingdocument
*                  and   companycode        = ls_itm-companycode
*                  and   product            =  ls_item-item_name .
*
...
*              ls_item-item_deduction  = ls_item-item_deduction + itm_ded-amountincompanycodecurrency.
          ...
          CLEAR: itm_ded, ls_item, wa_ekpo, wa_token_data ,dec.

        ENDLOOP.

*        SORT lt_item  BY item_name.
*        DELETE ADJACENT DUPLICATES FROM lt_item  COMPARING item_name .
...
*      ENDIF.
      ...
      READ TABLE it_tax INTO DATA(wa_tax) WITH KEY transactiontypedetermination = 'JIC'.
      IF sy-subrc = 0.
        gs_final-cgst_amt = wa_tax-amountincompanycodecurrency.
      ...
      CLEAR wa_tax.
      READ TABLE it_tax INTO wa_tax WITH KEY transactiontypedetermination = 'JIS'.
      IF sy-subrc = 0.
        gs_final-sgst_amt = wa_tax-amountincompanycodecurrency.
        IF wa_tax-taxbaseamountincocodecrcy IS NOT INITIAL.
      ...
      CLEAR wa_tax.
      READ TABLE it_tax INTO wa_tax WITH KEY transactiontypedetermination = 'JII'.
      IF sy-subrc = 0.
        gs_final-igst_amt = wa_tax-amountincompanycodecurrency.
        IF wa_tax-taxbaseamountincocodecrcy IS NOT INITIAL.
