...
left outer join I_CompanyCode as comp
on comp.CompanyCode = dc.CompanyCode  

left outer join ZI_SUPPLIER_ADDRESS as suppl
on suppl.Supplier = dc.Supplier

left outer join ZI_CUSTOMER_ADDRESS as cust
on cust.Customer = dc.Customer                                                        
{
  ...
  key dc.AccountingDocumentItem,
      ...
      dc.ClearingJournalEntry as ClearingAccountingDocument,
      dc.ClearingDate,
