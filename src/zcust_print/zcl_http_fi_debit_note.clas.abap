  ...
  METHOD if_http_service_extension~handle_request.
    ...
    IF lv_action1 = 'fidebit'.
      ...
      rv_response = lo_ads->get_ads_api_toget_base64(
        ...
        im_template_name = 'ZFI_FORM_DEBIT_NOTE/ZFI_BLV_DEBIT_NOTE'
...
*""**Setiing response/pdf in base64 format to UI5
    ...
    IF lv_action1 = 'payadv'.
      ...
      rv_response = lo_ads->get_ads_api_toget_base64(
        im_access_token  = lv_access_token
        im_template_name = 'ZFI_FORM_PAY_ADV/ZFI_BLV_PAY_ADV'
        im_xml_base64    = ls_xml_base64 ).
...
*""**Setiing response/pdf in base64 format to UI5
    ...
    IF lv_action1 = 'chqprnt'.
      ...
      rv_response = lo_ads->get_ads_api_toget_base64(
        im_access_token  = lv_access_token
        im_template_name = 'ZFI_FORM_CHQ_PRINT/ZFI_BLV_CHQ_PRINT'
        im_xml_base64    = ls_xml_base64 ).
...
*""**Setiing response/pdf in base64 format to UI5
    ...
    IF lv_action1 = 'ficredit'.
      ...
      rv_response = lo_ads->get_ads_api_toget_base64(
        im_access_token  = lv_access_token
        im_template_name = 'ZFI_FORM_CREDIT_NOTE/ZFI_BLV_CREDIT_NOTE'
        im_xml_base64    = ls_xml_base64 ).
...
*""**Setiing response/pdf in base64 format to UI5
    ...
    IF lv_action1 = 'fitaxinv'.
      ...
      rv_response = lo_ads->get_ads_api_toget_base64(
        im_access_token  = lv_access_token
        im_template_name = 'ZFI_FORM_TAX_INVOICE/ZFI_BLV_TAX_INV'
        im_xml_base64    = ls_xml_base64 ).
...
*""**Setiing response/pdf in base64 format to UI5
    ...
    IF lv_action1 = 'fircm'.
      ...
      rv_response = lo_ads->get_ads_api_toget_base64(
        im_access_token  = lv_access_token
        im_template_name = 'ZFI_FORM_RCM/ZFI_BLV_RCM_INVOICE'
        im_xml_base64    = ls_xml_base64 ).
