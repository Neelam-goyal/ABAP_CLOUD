...
CLASS ZCL_READ_TEXT IMPLEMENTATION.
  ...
  METHOD read_text_billing_header.
   ...
   CONSTANTS:
       lv_dev_id TYPE c LENGTH 3 VALUE 'ZSZ',
       lv_qas_id TYPE c LENGTH 3 VALUE 'CCX',
       lv_prd_id TYPE c LENGTH 3 VALUE 'CYK'.
...
*    IF lv_sysid = lv_dev_id.
*
*      lv_url1     = 'https://my408424.s4hana.cloud.sap:443/sap/opu/odata/sap/API_BILLING_DOCUMENT_SRV/A_BillingDocument(%27'.
*      lv_api_pass = lv_obj_val. "'R7ADqslXWrzCQdCZsWwzWTElSKhBcnbbvird@HKH'.
*
*    ELSEIF lv_sysid = lv_qas_id.
*
*      lv_url1     = 'https://my409905.s4hana.cloud.sap:443/sap/opu/odata/sap/API_BILLING_DOCUMENT_SRV/A_BillingDocument(%27'.
*      lv_api_pass = lv_obj_val. "'NyAxiKeYcJy2aAltcXs@FwcQyPZSqAEaHnNEwGRy'.
*
*    ELSEIF lv_sysid = lv_prd_id.
*
*      lv_url1     = 'https://my411581.s4hana.cloud.sap:443/sap/opu/odata/sap/API_BILLING_DOCUMENT_SRV/A_BillingDocument(%27'.
*      lv_api_pass = lv_obj_val. "'FoPZYYtgChSbwhqUrmbZjetcE4oHeGDnAikSZ\XJ'.
*
*    ENDIF.
...
*    ENDIF.
*
*    IF lv_sysid = 'ZSZ' ##NO_TEXT.
*
*      lv_url1     = 'https://my408424.s4hana.cloud.sap:443/sap/opu/odata/sap/API_BILLING_DOCUMENT_SRV/A_BillingDocumentItem(BillingDocument=%27' ##NO_TEXT.
*      lv_api_pass = lv_obj_val. "'R7ADqslXWrzCQdCZsWwzWTElSKhBcnbbvird@HKH' ##NO_TEXT.
*
*    ELSEIF lv_sysid = 'CCX' ##NO_TEXT.
*      lv_url1     = 'https://my409905.s4hana.cloud.sap:443/sap/opu/odata/sap/API_BILLING_DOCUMENT_SRV/A_BillingDocumentItem(BillingDocument=%27' ##NO_TEXT.
*      lv_api_pass = lv_obj_val. "'NyAxiKeYcJy2aAltcXs@FwcQyPZSqAEaHnNEwGRy' ##NO_TEXT.
*
*    ELSEIF lv_sysid = 'CYK' ##NO_TEXT.
*
*      lv_url1     = 'https://my411581.s4hana.cloud.sap:443/sap/opu/odata/sap/API_BILLING_DOCUMENT_SRV/A_BillingDocumentItem(BillingDocument=%27' ##NO_TEXT.
...
*    ENDIF.
    ...
    IF lv_sys_url IS NOT INITIAL.
      ...
      lv_url1     = lv_sys_url && '/sap/opu/odata/sap/API_BILLING_DOCUMENT_SRV/A_BillingDocumentItem(BillingDocument=%27'.
      lv_api_pass = lv_obj_val.
