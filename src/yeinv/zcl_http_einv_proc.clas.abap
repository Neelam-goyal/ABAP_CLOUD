CLASS zcl_http_einv_proc DEFINITION
  PUBLIC
  CREATE PUBLIC .

  PUBLIC SECTION.
    DATA:
      lo_einv         TYPE REF TO zcl_einv_process,
...
CLASS ZCL_HTTP_EINV_PROC IMPLEMENTATION.
